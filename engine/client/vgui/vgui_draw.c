...
void VGUI_InitKeyTranslationTable( void )
{
	...
	s_pVirtualKeyTrans['A'] = s_pVirtualKeyTrans['a'] = KEY_V_A;
	s_pVirtualKeyTrans['B'] = s_pVirtualKeyTrans['b'] = KEY_V_B;
	...
	s_pVirtualKeyTrans['L'] = s_pVirtualKeyTrans['l'] = KEY_V_L;
	...
	s_pVirtualKeyTrans['R'] = s_pVirtualKeyTrans['r'] = KEY_V_R;
	...
	s_pVirtualKeyTrans['X'] = s_pVirtualKeyTrans['x'] = KEY_V_X;
	s_pVirtualKeyTrans['Y'] = s_pVirtualKeyTrans['y'] = KEY_V_Y;
	...
	s_pVirtualKeyTrans[K_UPARROW] = KEY_V_UP;
	s_pVirtualKeyTrans[K_LEFTARROW] = KEY_V_LEFT;
	s_pVirtualKeyTrans[K_DOWNARROW] = KEY_V_DOWN;
	s_pVirtualKeyTrans[K_RIGHTARROW] = KEY_V_RIGHT;
